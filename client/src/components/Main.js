      ...
      <div className="w3-container" id="menu">
        <div className="w3-content" style="max-width:700px">
          ...
          <div id="Eat" className="w3-container menu w3-padding-48 w3-card">
            <h5>Bread Basket</h5>
            <p className="w3-text-grey">Assortment of fresh baked fruit breads and muffins</p><br>

            <h5>Honey Almond Granola with Fruits</h5>
            <p className="w3-text-grey">Natural cereal of honey toasted oats, raisins, almonds and dates</p><br>

            <h5>Belgian Waffle</h5>
            <p className="w3-text-grey">Vanilla flavored batter with malted flour</p><br>

            <h5>Scrambled eggs</h5>
            <p className="w3-text-grey">Scrambled eggs, roasted red pepper and garlic, with green onions</p><br>
          ...
          <div id="Drinks" className="w3-container menu w3-padding-48 w3-card">
            <h5>Americano</h5>
            <p className="w3-text-grey">A shot or two of espresso with hot water added</p><br>

            <h5>Cappuccino</h5>
            <p className="w3-text-grey">Espresso with a little bit of steamed milk topped with a lot of foam</p><br>

            <h5>Mocha</h5>
            <p className="w3-text-grey">Espresso with steamed milk and chocolate (you can add whipped cream as well!)</p><br>

            <h5>>Espresso</h5>
            <p className="w3-text-grey">Coffee brewed by forcing a small amount of nearly boiling water under pressure through finely ground beans.</p><br>
